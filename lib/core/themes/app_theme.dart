...
class AppTheme {
  ...
  static final lightTheme = ThemeData(
    ...
    primaryColor: const Color(0xFF4A90E2), // custom blue
    scaffoldBackgroundColor: const Color(0xFFf7f9fd), // light gray background
    ...
    cardColor: Colors.white, // for cards
  ...
  static final darkTheme = ThemeData(
    ...
    scaffoldBackgroundColor: const Color(ConstsColors.kmaindarkcolor), // light gray background
    appBarTheme: const AppBarTheme(
